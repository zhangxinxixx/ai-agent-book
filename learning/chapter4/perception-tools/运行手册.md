...
| --- | --- | --- |
| Code / 代码 | [`code/src/`](code/src/), [`smoke_test_mcp_v2.py`](code/smoke_test_mcp_v2.py), [`run_experiment_4_2.py`](code/run_experiment_4_2.py) | MCP Server, minimal smoke path, and the full campaign / MCP Server、最短冒烟链和完整 campaign |
