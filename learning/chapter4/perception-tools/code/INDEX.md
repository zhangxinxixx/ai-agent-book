...
### Documentation
- [学习笔记.md](../学习笔记.md) - Experiment 4-2 MCP concepts and first-pass learning path
- [实验逻辑流程.md](../实验逻辑流程.md) - Source-grounded initialize / tools-list / tools-call flow
- [实验总结.md](../实验总结.md) - Current smoke evidence, conclusions, and limitations
